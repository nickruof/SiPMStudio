...
def reprocess(settings_dict, proc_dict, processor, verbose=False):
...
def reprocess_files(settings_file, proc_file, verbose=False):
    ...
    processor = Processor()
    reprocess(settings_dict, proc_dict, processor, verbose=verbose)
...
if __name__ == "__main__":
    ...
    reprocess_files(args.settings, args.procs, verbose=args.verbose)
